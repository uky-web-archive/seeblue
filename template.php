...
if ( is_null( theme_get_setting( 'site_description' ) ) )
{
  ...
  */
  $defaults = array(             // <-- change this array
    ...
    'site_description' => " ",
    'front_logo' => seeblue201408_save_file( theme_get_setting("front_logo")),
    'interior_logo' => seeblue201408_save_file(theme_get_setting("interior_logo"))
  );
 ...
 *
 */
function seeblue201408_preprocess_image(&$variables)
{
 ...
 *	@author Miles Briggs
 */
function seeblue201408_preprocess_views_view(&$variables)
{
 ...
 *
 */
function seeblue201408_preprocess_page(&$variables)
{
  /**
 ...
 *
 */
function seeblue201408_form_alter(&$form, &$form_state, $form_id)
{
...
*/
function seeblue201408_save_file($uri)
{
global $user;
